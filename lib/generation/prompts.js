...
This PERSONA_DATA provides optional player personas that define the player character's identity and perspective. **Persona is not required** — if absent, derive character perspective from the story setup characters and world info.
...
**If no persona is present:** Proceed using story setup characters, world/lore data, and the user scenario. Do not request or require a persona to continue.
