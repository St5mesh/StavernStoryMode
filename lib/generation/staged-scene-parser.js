...
// Validate once at module load; import contracts are static for runtime extension modules.
const stagedValidationHelpers = getStagedValidationHelpers();
...
export function parseStagedResponse(subPhase, rawText, maxTokens, expectedIndices) {
    ...
    const { validateScenePlanOutput, validateSceneBatchOutput, normalizeStagedScenePayload } = stagedValidationHelpers;
